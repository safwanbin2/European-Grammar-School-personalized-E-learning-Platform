...
const Footer = () => {
  return (
    <div className="w-full pt-14 flex items-center justify-center bg-base-300">
      <div className="w-11/12 text-white flex flex-col">
        ...
        <div className="flex mt-8 flex-col md:flex-row md:justify-between">
          <p className="w-full md:w-2/3 text-gray-400">
            Elevate understanding by rating users and sharing feedback to gain
            valuable insights into people's perceptions and qualities.
          </p>
          <div className="w-44 pt-6 md:pt-0">
            <Link to={"/contact-me"} className="p-btn">
              Contact US
            </Link>
          </div>
        </div>
        <div className="flex flex-col">
          <div className="flex mt-10 mb-12 flex-col md:flex-row justify-between gap-2 md:gap-0">
          ...
          <p className="w-full text-center my-12 text-gray-600">
            Copyright © 2024 Rating - All rights reserved.
          </p>
        </div>
      </div>
    </div>
